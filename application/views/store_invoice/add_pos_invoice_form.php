    ...
    <div class="content">
        ...
        <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-4 col-p-3">
                            <div class="panel panel-bd product-panel select_product">
                                <div class="panel-body">
                                    <img src="<?=base_url($product->image_thumb)?>" class="img-responsive" alt="">
            ...
            <div class="col-sm-7">
                ...
                <div class="panel panel-bd">
                    <div class="panel-body">
                        ...
                        <div class="input-group">
                            ...
                            <?php date_default_timezone_set("Asia/Jakarta"); $date = date('m-d-Y'); ?>
                        </div>

                        <?php echo form_open_multipart('Store_invoice/insert_invoice2',array('class' => 'form-vertical', 'id' => 'validatex'))?>
				...
				<?php /*<?=$date?> m-d-Y*/ ?>
                        <input class="form-control" type="hidden" id="invoice_date" name="invoice_date" required value="<?=$date?>" />                
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <th>Total Qty of All Products</th>
                                        <td><input type="text" id="total_qty_product" class="form-control text-right"
                                                name="total_qty_product" value="0" placeholder="0" readonly="readonly"/></td>
                                    </tr>
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="button" class="btn btn-black m-b-5 payment_button"><?php echo display('payment')?></button>
                        ...
                        <!-- <button id="reprint" type="btn btn-warning m-b-5" class="btn btn-success m-b-5">Reprint</button> -->
                    </div>
      ...
      <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6" style="margin-left:auto">
                <button id="printID" data-id="0" class="btn btn-success btn-block">Print</button>
            </div>
            <div class="col-md-6" style="margin-right:auto">
                <button id="shareID" data-id="0" class="btn btn-success btn-block">Share</button>
            </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    function get_productr(product_id) {
        ...
        $.ajax({
            ...
            dataType: "json",
            async: false,
            url: '<?php echo base_url('Store_invoice/insert_pos_invoice2')?>',
            data: {product_id: new_product_code, store_id:store_id},
	...
	function captureUrl(id) {
        ...
        $iframe.src = '<?= base_url('Store_invoice/pos_invoice_inserted_data_redirect/') ?>' + id;
		...
		return [
            {
                ...
                format: 'html',
                flavor: 'file',
                data: '<?= base_url('Store_invoice/pos_invoice_inserted_data_redirect/') ?>' + id,
    ...
    $("#reprint").click(function(){
        //$("#printID").attr("data-id", "TNF27XQU1H1NYDG");
        //$("#shareID").attr("data-id", "TNF27XQU1H1NYDG");
        $("#return_modal").modal("show");
    });
    ...
    $("#shareID").click((e)=>{
        ...
        $iframe.src = '<?= base_url('Store_invoice/pos_invoice_inserted_data_redirect/') ?>' +$(e.target).attr("data-id");
        var timeriframe = setInterval(function () {
...
<script type="text/javascript">
    ...
    $('body').on('keyup', '#product_name', function () {
        ...
        $.ajax({
            type: "post",
            async: false,
            url: '<?php echo base_url('Store_invoice/search_product')?>',
