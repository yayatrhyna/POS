...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('update_web_color') ?></h1>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Csoft_setting/update_frontend_color', array('class' => 'form-vertical','id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <small><?php echo display('fe_color1')?></small>
                            </div>
                        </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <small><?php echo display('fe_color2')?></small>                                
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="color3" value="{color3}" id="color3" type="color">
                                 <small><?php echo display('fe_color3')?></small>
                            </div>
                        </div>
                               <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name ="color4" value="{color4}" id="color4" type="color">
                                 <small><?php echo display('fe_color4')?></small>
                            </div>
                        </div>
