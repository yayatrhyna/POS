		                    ...
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
								...
								foreach ($products_list as $v_product_list):
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url() . 'Cproduct/product_details/'.$v_product_list['product_id']; ?>">
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <a href="<?php echo base_url() . 'Cqrcode/qrgenerator/'.$v_product_list['product_id']; ?>"
                                                   class="btn btn-success btn-sm" data-toggle="tooltip"
                                                   data-placement="left" title="<?php echo display('qr_code') ?>"><i
                                                            class="fa fa-qrcode" aria-hidden="true"></i></a>

                                                <a href="<?php echo base_url() . 'Cbarcode/barcode_print/'.$v_product_list['product_id']; ?>"
                                                   class="btn btn-warning btn-sm" data-toggle="tooltip"
                                                   data-placement="left" title="<?php echo display('barcode') ?>"><i
                                                            class="fa fa-barcode" aria-hidden="true"></i></a>

                                                <a href="<?php echo base_url() . 'Cproduct/product_update_form/'.$v_product_list['product_id']; ?>"
                                                   class="btn btn-info btn-sm" data-toggle="tooltip"
                                                   data-placement="left" title="<?php echo display('update') ?>"><i
                                                            class="fa fa-pencil" aria-hidden="true"></i></a>

                                                <a href="<?php echo base_url('Cproduct/product_delete/').$v_product_list['product_id']; ?>"
