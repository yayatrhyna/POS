	    ...
	    <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cproduct')?>" class="btn -btn-info color4 color5 m-b-5 m-r-2"><i class="ti-plus"> </i><?php echo display('add_product')?></a>

                  <a href="<?php echo base_url('Cproduct/add_product_csv')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-plus"> </i><?php echo "Import Product"?></a>
		                    ...
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								{purchaseData}
									<tr>
										<td>{final_date}</td>
										<td>
											<a href="<?php echo base_url().'Cpurchase/purchase_details_data/{purchase_id}'; ?>">{invoice_no} <i class="fa fa-tasks pull-right" aria-hidden="true"></i>
											</a>
										</td>
										<td>
											<a href="<?php echo base_url().'Csupplier/supplier_details/{supplier_id}'; ?>">{supplier_name} <i class="fa fa-user pull-right" aria-hidden="true"></i></a>
										</td>
										<td>{quantity}</td>
		                    ...
		                    <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
								...
								{salesData}
									<tr>
										...
										<td>
											<a href="<?php echo base_url().'Ccustomer/customer_ledger/{customer_id}'; ?>">{customer_name} <i class="fa fa-user pull-right" aria-hidden="true"></i></a>
										</td>
										<td>{quantity}</td>
										<td> <?php echo (($position==0)?"$currency {rate}":"{rate} $currency") ?></td>
