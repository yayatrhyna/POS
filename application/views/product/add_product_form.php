        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                    ...
                    <a href="<?php echo base_url('Cproduct/add_product_csv')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"></i>  <?php echo "Import Product"?></a>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="variant[]" class="form-control select2" required="" multiple style="width: 100%" id="variant">
                                                <option></option>
                                                <?php if ($variant_list){ ?>
                                                    {variant_list}
