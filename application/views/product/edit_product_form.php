...
<!--                                                    <img class="img img-responsive text-center" src="--><?php //echo base_url()?><!--{image_thumb}" height="80" width="80" style="padding: 5px;">-->
...
<!--                                        </div>-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea class="form-control summernote" name="details" id="details" rows="3" >{product_details}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <select name="default_variant" class="form-control select2"   style="width: 100%" id="default_variant">
                                                <option></option>
                                                <?php if ($result){
                                                    foreach ($result as $v_item){                                                    ?>
                                                        <option value="<?php echo $v_item->variant_id  ?>" <?php if($v_item->variant_id == $default_variant){echo "selected";}  ?>><?php echo $v_item->variant_name;  ?></option>
                                                    <?php } }?>
                                            </select>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            ...
                                                            <img class="img img-responsive text-center" src="<?php echo base_url().$gallery_image->image_url;?>" height="80" width="80" style="padding: 5px;">
...
<script type="text/javascript">
    ...
    $('#variant').on('change', function () {
        ...
        $.ajax({
            url:"<?php echo base_url().'Cproduct/get_default_variant';?>",
            type:"post",
       ...
       if(imageId){
           swal({
               ...
               .then((willDelete) => {
                   if (willDelete) {
                       $.ajax({
                           url:"<?php echo base_url().'Cproduct/delete_gallery_image';?>",
                           type:"post",
