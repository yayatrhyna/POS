            ...
            <div class="col-sm-12 col-md-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                       <a href="<?php echo base_url('assets/data/csv/category_csv_sample.csv') ?>" class="btn color4 color5 pull-right"><i class="fa fa-download"></i>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    <div class="panel-heading">
                     ...
                     <?php echo form_open_multipart('Ccategory/uploadCsv',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_product'))?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
