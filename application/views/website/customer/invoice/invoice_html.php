                ...
                <div class="panel panel-bd">
	                <div id="printableArea">
	                    <div class="panel-body">
	                        <div class="row">
	                        	{company_info}
	                            <div class="col-sm-8" style="display: inline-block;width: 68%">
	                                 <img src="<?php if (isset($Soft_settings[0]['invoice_logo'])) {echo base_url().$Soft_settings[0]['invoice_logo']; }?>" class="img img-responsive" alt="" style="margin-bottom:20px">
	                                <br>
	                            ...
	                            {/company_info}
	                            <div class="col-sm-4 text-left" style="display: inline-block;margin-left: 5px; width: 30%"">
	                                <h4 class="m-t-0">
	                        ...
	                        <div class="row">
		                        <div class="col-sm-12">
		                        	<div class="col-sm-8" style="display: inline-block;width: 70%">
		                                <p><strong><?php echo $details?></strong></p>
		                            </div>

		                            <div class="col-sm-4" style="display: inline-block;width: 30%">
			                            	...
			                            	<tr>
			                            		...
			                            		<td style="border-top: 0; border-bottom: 0;"><?php echo (($position==0)?"$currency {total_discount}":"{total_discount} $currency") ?> </td>
                                                  ...
                                                  <?php if ($invoice_all_data[0]['invoice_discount'] != 0) {?>
                                                    <tr>
			                            		<th style="border-top: 0; border-bottom: 0;"><?php echo display('invoice_discount') ?> : </th>
			                            		<td style="border-top: 0; border-bottom: 0;"><?php echo (($position==0)?"$currency {invoice_discount}":"{invoice_discount} $currency") ?> </td>
			                            	</tr>
                                                      <?php } ?>

                                                    <?php if ($invoice_all_data[0]['service_charge'] != 0) {?>
                                                    <tr>
			                            		<th style="border-top: 0; border-bottom: 0;"><?php echo display('service_charge') ?> : </th>
			                            		<td style="border-top: 0; border-bottom: 0;"><?php echo (($position==0)?"$currency {service_charge}":"{service_charge} $currency") ?> </td>
			                            	</tr>
                                                      <?php } ?>

                                                    <?php if ($invoice_all_data[0]['shipping_charge'] != 0) {?>
                                                    <tr>
			                            		<th style="border-top: 0; border-bottom: 0;"><?php echo display('shipping_charge') ?> : </th>
			                            		<td style="border-top: 0; border-bottom: 0;"><?php echo (($position==0)?"$currency {shipping_charge}":"{shipping_charge} $currency") ?> </td>
			                            	</tr>
                                                      <?php } ?>


                                                    <?php if ($invoice_all_data[0]['shipping_method'] != '') {?>
                                                    <tr>
			                            		<th style="border-top: 0; border-bottom: 0;"><?php echo display('shipping_method') ?> : </th>
			                            		<td style="border-top: 0; border-bottom: 0;"><?php echo $shipping_method; ?> </td>
			                            	</tr>
                                                      <?php } ?>
             <?php } 
                     ...
                     <div class="panel-footer text-left">
                     	<a  class="btn btn-danger" href="<?php echo base_url('customer/invoice');?>"><?php echo display('cancel') ?></a>
