	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-8" style="display: inline-block;width: 64%">
	                                <img src="<?php if (isset($Soft_settings[0]['invoice_logo'])) {echo base_url().$Soft_settings[0]['invoice_logo']; }?>" class="img img-responsive" alt="" style="margin-bottom:20px;height: 55px;">
	                                <br>
