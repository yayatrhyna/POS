...
<section class="page_header">
    <div class="container">
        <div class="row m0 page_header_inner">
            <h5><?php echo $total." " ; echo display('search_items'); echo  " \"$keyword \""; ?> </h5>
            <a class="btn btn-warning color3 mt-3" href="<?php echo base_url()?>"><i class="fa fa-hand-o-left" aria-hidden="true"></i>
                        ...
                        <div class="item item_shadow">
                            ...
                            <div class="item_hover">
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url().$product->image_thumb?>" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                    </li>
                                    <li>
