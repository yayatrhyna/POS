                                ...
                                <div class="tab-pane" id="product_<?php echo $gallery->image_gallery_id ?>"
                                    ...
                                    <div class="easyzoom easyzoom--adjacent">
                                        <a href="<?php echo base_url().$gallery->image_url ?>">
                                            <img src="<?php echo base_url().$gallery->image_url ?>" alt="productImage">
                                        </a>
                                    </div>
                                </div>
                                <?php
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#product1" role="tab">
                                <img src="<?php echo base_url().$image_thumb ?>" alt="" style="height:  80px;width:  80px;">
                            </a>
                            <input type="hidden" name="image" id="image" value="<?php echo base_url().$image_thumb ?>">
                        </li>
                        <?php
                        if ($product_gallery_img) {
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab"
                                       href="#product_<?php echo $gallery_tab_img->image_gallery_id ?>" role="tab">
                                        <img src="<?php echo base_url().$gallery_tab_img->image_url ?>" alt=""
                ...
                <div class="row db m0 product_info">
                    <ol class="breadcrumb m0 p0">
                        ...
                        <li class="breadcrumb-item"><a
                                    href="<?php echo base_url('category_product/' . $category_id) ?>"><?php echo $category_name ?></a>
                        </li>
                        ...
                        <div class="product_cost">
                            ...
                            <div class="previous">
                                ...
                                <input type="hidden" id="discount" name="discount"
                                       value="<?php echo $price - $onsale_price ?>">
                            </div>
                        </div>
                        <?php
                    } else {
                    ...
                    if ($variant) { ?>
                        <div class="product_size">
                            ...
                            <form action="#">
                                <select id="select_size1" required="" class="form-control">
                    ...
                    if ($stok > 0) {
                        ?>
                        <a href="#" id="cart_btn" class="cart_btn color3" onclick="cart_btn(<?php echo $product_id ?>)">
                    ...
                    <div class="product_share">
                        <span class="share-title"><?php echo display('share') ?> : <div class="sharethis-inline-share-buttons"></div><!--social share buttons--></span>

<!--                        <ul class="social-icons">-->
<!--                            <li>-->
<!--                                <a class="share-button" data-share-url="--><?php //echo current_url(); ?><!--"-->
...
<!--                                   data-share-media="" href="#"><i class="fa fa-facebook"></i></a>-->
<!--                            </li>-->
<!--                            <li>-->
<!--                                <a class="share-button" data-share-url="--><?php //echo current_url(); ?><!--"-->
...
<!--                                   data-share-media="" href="#"><i class="fa fa-twitter"></i></a>-->
<!--                            </li>-->
<!---->
<!--                            <li>-->
<!--                                <a class="share-button" data-share-url="--><?php //echo current_url(); ?><!--"-->
...
<!--                                   data-share-media="" href="#"><i class="fa fa-linkedin"></i></a>-->
<!--                            </li>-->
<!--                            <li>-->
<!--                                <a class="share-button" data-share-url="--><?php //echo current_url(); ?><!--"-->
...
<!--                                   data-share-media="" href="#"><i class="fa fa-pinterest"></i></a>-->
<!--                            </li>-->
<!--                        </ul>-->
                    </div>
                </div>
...
<section class="product_review_area">
    <div class="container">
        <div class="row m0 db product_review">
            ...
            <ul class="nav nav-pills" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#reviews"
                        ...
                        <div class="item">
                            <div class="item_inner">
                                ...
                                <div class="item_hover">
                                    <ul class="nav">
                                        <li>
                                            <a href="#" class="wishlist" name="<?php echo $product->product_id ?>"><i
                                                        class="fa fa-heart"></i></a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url().$product->image_thumb ?>" data-lightbox="image-1"><i
                                    ...
                                    <div class="addtocard">
                                        <form action="" method="post">
                                            <input type="hidden" name=""
                                                   id="product_id_<?php echo $product->product_id ?>" class="product_id"
                                                   value="<?php echo $product->product_id ?>">

                                            <?php if ($product->onsale == 1 && !empty($product->onsale_price)) { ?>
                                                <input type="hidden" name="price"
                                                       id="price_<?php echo $product->product_id ?>"
                                                       value="<?php echo $product->onsale_price ?>">
                                                <input type="hidden" name="discount"
                                                       id="discount_<?php echo $product->product_id ?>"
                                                       value="<?php echo($product->price - $product->onsale_price) ?>">
                                            <?php } else { ?>
                                                <input type="hidden" name="price"
                                                       id="price_<?php echo $product->product_id ?>"
                                            ...
                                            <input type="hidden" name="qnty"
                                                   id="qnty_<?php echo $product->product_id ?>" value="1">
                                            <input type="hidden" name="image"
                                                   id="image_<?php echo $product->product_id ?>"
                                                   value="<?php echo $product->image_thumb ?>">
                                            <input type="hidden" name="name"
                                                   id="name_<?php echo $product->product_id ?>"
                                                   value="<?php echo $product->product_name ?>">
                                            <input type="hidden" name="model"
                                                   id="model_<?php echo $product->product_id ?>"
                                                   value="<?php echo $product->product_model ?>">
                                            <input type="hidden" name="supplier_price"
                                                   id="supplier_price_<?php echo $product->product_id ?>"
                                            ...
                                            if (!empty($tax_info)) {
                                                ...
                                                <?php if ($product->onsale == 1 && !empty($product->onsale_price)) {
                                                    ...
                                                    <input type="hidden" name="cgst"
                                                           id="cgst_<?php echo $product->product_id ?>"
                                                           value="<?php echo $cgst ?>">
                                                    <input type="hidden" name="cgst_id"
                                                           id="cgst_id_<?php echo $product->product_id ?>"
                                                           value="<?php echo $tax_info->tax_id ?>">
                                                <?php } else {
                                            ...
                                            if (!empty($tax_info)) {
                                                ...
                                                <?php if ($product->onsale == 1 && !empty($product->onsale_price)) {
                                                    ...
                                                    <input type="hidden" name="sgst"
                                                           id="sgst_<?php echo $product->product_id ?>" class=""
                                                           value="<?php echo $sgst ?>">
                                                    <input type="hidden" name="sgst_id"
                                                           id="sgst_id_<?php echo $product->product_id ?>"
                                                           value="<?php echo $tax_info->tax_id ?>">
                                                <?php } else {
                                            ...
                                            if (!empty($tax_info)) {
                                                ...
                                                <?php if ($product->onsale == 1 && !empty($product->onsale_price)) {
                                                    ...
                                                    <input type="hidden" name="igst"
                                                           id="igst_<?php echo $product->product_id ?>" class=""
                                                           value="<?php echo $igst ?>">
                                                    <input type="hidden" name="igst_id"
                                                           id="igst_id_<?php echo $product->product_id ?>"
                                                           value="<?php echo $tax_info->tax_id ?>">
                                                <?php } else {
                                            ...
                                            <a href="<?php echo base_url('product_details/'.remove_space($product->product_name).'/' . $product->product_id) ?>">
                                                <button type="button"
                                                        class="cart_button color2"><?php echo display('add_to_cart')
                                                    ?></button>
                                            </a>
                                        </form>
                                    </div>
