            ...
            <div class="col-sm-12">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo form_open_multipart('Ctheme/upload_new_theme'); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="submit" value="<?php echo display('save') ?>" name="upload_theme"
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="thumbnail theme_img">
                                        <img src="<?php echo base_url() . 'application/views/website/themes/' .
                                            $single_theme->name . '/preview.png'; ?>"
                                             alt="<?php echo $single_theme->name; ?>">
                                    </div>
                                    <div class="caption">
                                        ...
                                        <p>
                                            ...
                                            if (@$theme !== $single_theme->name) {
                                                echo '<a href="' . base_url() . 'Ctheme/active_theme/' . $single_theme->name . '" class="btn btn-danger" role="button">' . display('in_active') . '</a>';
                                            }else{
                                              ?>
