...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="row">
            <div class="col-sm-12">
                <div class="column">
                    <a href="<?php echo base_url('Admin_dashboard/todays_sales_report')?>" class="btn -btn-info color5 color4 m-b-5 m-r-2"><i class="ti-align-justify"> </i><?php echo display('sales_report')?></a>
                </div>
            </div>
        </div>
			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		                <?php echo form_open('Admin_dashboard/tax_report_product_wise',array('class' => 'form-inline'))?>
		            ...
		            <div class="panel-body">
		                <div class="table-responsive">
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
								...
								?>
									{tax_report_product_wise}
										<tr>
											...
											<td>{product_name}</td>
											<td>{tax_name}</td>
											<td style="text-align: right;"><?php echo (($position==0)?"$currency {amount}":"{amount} $currency") ?></td>
										</tr>
									{/tax_report_product_wise}
								<?php
									}
								...
								<tfoot>
									<tr>
										<td colspan="4" align="right" style="text-align:right;font-size:14px !Important">&nbsp; <b><?php echo display('total_tax') ?> </b></td>
