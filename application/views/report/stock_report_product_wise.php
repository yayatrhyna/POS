			                    ...
			                    <table id="" class="table table-bordered table-striped table-hover">
									...
									{stok_report}
										<tr>
											<td>{date}</td>
											<td align="center">
												<a href="<?php echo base_url().'Cproduct/product_details/{product_id}'; ?>" title="total stock report">{product_name}-({product_model}) </a>
                                                <a href="<?php echo base_url().'Creport/stock_by_variant/{product_id}'; ?>"><i class="fa fa-shopping-bag pull-right" title="stock report variant wise" aria-hidden="true"></i></a>
