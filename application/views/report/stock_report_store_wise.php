                                ...
                                <table id="" class="table table-bordered table-striped table-hover">
                                    ...
                                    if ($store_product_list) {
                                        ...
                                        <?php foreach($store_product_list as $product):
                                            ...
                                            ?>
                                            <tr>
                                                <td class="text-center"><?php echo $product['sl'] ?></td>
                                                <td class="text-center"><?php echo $product['store_name']?></td>
                                                <td class="text-center"><a href="<?php echo base_url('Cproduct/product_details/'.$product['product_id'])?>">
                                                        <?php echo $product['product_name']?>-(<?php echo $product['product_model']?>)</a></td>
                                                <td class="text-center"><?php echo $product['variant_name']?></td>
                                                <td class="text-center"><?php echo $product['quantity']?></td>
                                                <td class="text-center"><?php echo $product['sell']?></td>
                                                <?php if($stock < 10){?>
                                                    <td class="text-center text-danger"><strong><?php echo $stock;?></strong></td>
                                                <?php }else{?>
