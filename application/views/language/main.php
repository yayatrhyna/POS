...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12"> 
                <a href="<?= base_url('Language/phrase') ?>" class="btn -btn-info color4 color5">Add Phrase</a>
            </div>
        </div>
                                ...
                                <tbody>
                                    <?php if (!empty($languages)) {?>
                                        ...
                                        <tr>
                                            <td><?= $sl++ ?></td>
                                            <td><?= $language ?></td>
                                            <td><a href="<?= base_url("Language/editPhrase/$key") ?>" class="btn btn-xs btn-info"><i class="fa fa-edit"></i></a>  
                                           <?php if(strtolower($language) != 'english'){?>
                                            <a href="<?= base_url("Language/deletePhrase/$key") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure_want_to_delete')?>');" ><i class="fa fa-trash"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
