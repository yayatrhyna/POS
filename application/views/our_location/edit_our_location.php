...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('our_location_update') ?></h1>
            <small><?php echo display('our_location_update') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('web_settings') ?></a></li>
                <li class="active"><?php echo display('our_location_update') ?></li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('our_location_update') ?> </h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Cour_location/our_location_update/{position}',array('class' => 'form-vertical', 'id' => 'validate'))?>
                    <div class="panel-body">
                                ...
                                <div id="rootwizard">
                                    <div class="navbar">
                                        <div class="navbar-inner form-wizard">
                                            <ul class="nav nav-pills nav-justified steps">
                                                <?php
                                                if ($our_location_details) {
                                                    $i=1;
                                                    foreach ($our_location_details as $language) {
                                                ?>
                                                <li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab<?php echo $i?>">
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <textarea name="headlines[]" class="form-control summernote" placeholder="<?php echo display('headlines')?>" row="3"><?php echo $language['headline']?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-our_location" class="btn btn-success btn-large" name="add-our_location" value="<?php echo display('save_changes') ?>" />
