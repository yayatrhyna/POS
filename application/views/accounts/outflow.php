...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">                  
                  <a href="<?php echo base_url('Caccounts')?>" class="btn -btn-info color5 color4 m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_received')?></a>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                  	...
                  	<?php echo form_open_multipart('Caccounts/outflow_entry',array('class' => 'form-vertical', 'id' => 'validate'))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="transection_date" value="<?php echo $today; ?>" id="payment_date"  class="datepicker form-control" required/>
                            </div>
                        </div>
