            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                  	...
                  	<?php echo form_open_multipart('Caccounts/update_account_data',array('class' => 'form-vertical', 'id' => 'validate'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="submit" id="add-deposit" class="btn btn-success color4 color4" name="add-deposit" value="<?php echo display('save_changes') ?>" />
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
