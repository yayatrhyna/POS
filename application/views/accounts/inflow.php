        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Caccounts/outflow')?>" class="btn -btn-info color5 color4 m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_payment')?></a>
                  <a href="<?php echo base_url('Caccounts/summary')?>" class="btn btn-success color4 m-b-5 m-r-2"><i class="ti-align-justify"> </i><?php echo display('account_summary')?></a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Caccounts/inflow_entry',array('class' => 'form-vertical','id' => 'validate' ))?>
                    <div class="panel-body">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="transection_date" value="<?php echo $today; ?>" required id="payment_date"  class="datepicker form-control"/>
                            </div>
                        </div>
