        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cpay_with')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_pay_with')?></a>
      ...
      <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-bd lobidrag">
                ...
                <?php echo form_open_multipart('Cpay_with/store', array('class' => 'form-vertical','id' => 'validate'))?>
                <div class="panel-body">

                   <div class="form-group row">
                    <label for="category_name" class="col-sm-3 col-form-label"><?php echo display('title')?></label>
                    <div class="col-sm-6">
