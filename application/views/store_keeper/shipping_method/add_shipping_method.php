...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  <a href="<?php echo base_url('Cshipping_method/manage_shipping_method')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_shipping_method')?></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Cshipping_method/insert_shipping_method', array('class' => 'form-vertical','id' => 'validate'))?>
