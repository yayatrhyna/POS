                ...
                <div class="panel panel-bd">
                                ...
                                <div class="col-sm-2 text-left"
                                    ...
                                    <address style="margin-top:10px;">
                                        ...
                                        <?php  if ($customer_address) { ?>
                                            <c style="margin: 0;padding: 0;"><?php echo $customer_address; ?></c>
                                        <?php } ?><br>
                                    ...
                                    <div class="" style="width:width: 30%;float: left">
                                        ...
                                        <table class="table">
                                            <?php if ($order_all_data[0]['discount'] != 0) { ?>
                                                <tr>
                                                    <th style="border-top: 0; border-bottom: 0;"><?php echo display('total_discount') ?>
                                                        :
                                                    </th>
                                                    <td style="border-top: 0; border-bottom: 0;"><?php echo(($position == 0) ? "$currency {order_discount}" : "{order_discount} $currency") ?> </td>
                                                </tr>
                                            <?php }
                    ...
                    <div class="panel-footer text-left">
                        <a class="btn btn-danger"
                           href="<?php echo base_url('Corder'); ?>"><?php echo display('cancel') ?></a>
