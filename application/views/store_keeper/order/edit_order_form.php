                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <a href="<?php echo base_url('Ccustomer/customer_update_form/'.$order_all_data[0]['customer_id'])?>"> <button class="btn btn-warning" style="float: right;margin-top: -30px;"><?php echo display('customer_edit')?></button></a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                        	<div class="col-sm-6" id="">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                       <input type="text" name="customer_name" value="{customer_name}" class="form-control customerSelection" placeholder='<?php echo display('customer_name') ?>' id="customer_name" required readonly >
        ...
        ?>
                                ...
                                <td>
                                    <input type="text" name="available_quantity[]" id="avl_qntt_<?php echo $i?>" class="form-control text-right available_quantity_<?php echo $i?>" placeholder="0" readonly="" value="<?php echo $total_purchase->total_purchase - $total_sale->total_sale?>"/>
                            			...
                            			<td>
                                            ...
                                            <input type="hidden" name="order_details_id[]" id="order_details_id" value="<?php echo $value['order_details_id']?>"/>
                            			</td>
                                        <td>
                <?php
                    //Tax basic info
                ...
                <!-- Discount calculate end -->
                            	...
                            	<tfoot>
                                    <?php if ($tax['cgst_status'] ==1) { ?>
                                    <tr>
                                        <td style="text-align:right;" colspan="6"><b><?php echo $tax['cgst_name'] ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <?php } if ($tax['sgst_status'] ==1) { ?>       
                                    <tr>
                                        <td style="text-align:right;" colspan="6"><b><?php echo $tax['sgst_name'] ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <?php } if ($tax['igst_status'] ==1) { ?>      
                                    <tr>
                                        <td style="text-align:right;" colspan="6"><b><?php echo $tax['igst_name'] ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td colspan="4"  rowspan="4">
                                            ...
                                            <textarea class="form-control" name="details" id="details" rows="6" placeholder="<?php echo display('details')?>">{details}</textarea>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="invoice_discount" class="form-control text-right" name="invoice_discount" value="<?php if($order_discount){ echo $order_discount - $total_discount;}?>" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);"/>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="service_charge" class="form-control text-right" name="service_charge" value="<?php echo $service_charge?>" onkeyup="calculateSum();" onchange="calculateSum();"/>
                                        </td>
                                    </tr>
