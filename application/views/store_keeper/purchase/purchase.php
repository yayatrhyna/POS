									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url().'Cpurchase/purchase_details_data/'.$purchase['purchase_id']; ?>">
                                                <?php echo $purchase['invoice_no']?> <i class="fa fa-tasks pull-right" aria-hidden="true"></i>
                                            </a>
										</td>
										<td>
											<a href="<?php echo base_url().'Csupplier/supplier_details/'.$purchase['supplier_id']; ?>">
                                                <?php echo $purchase['supplier_name']?> <i class="fa fa-user pull-right" aria-hidden="true"></i>
                                            </a>
										</td>
										<td>
										<?php
