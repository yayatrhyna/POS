		        ...
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
	  					<div style="float:left">
				            ...
				            <?php echo display('date')?> :&nbsp;{final_date} <br /><?php echo display('invoice_no') ?> :&nbsp; {invoice_no}<br> {purchase_details} <span style="float:right"><?php echo display('print_date') ?> : <?php echo date("m/d/Y h:i:s");?> </span>
				            </th>
						</div>
		            </div>
		        </div>
