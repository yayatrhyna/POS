        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cblock/manage_block')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_block')?></a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Cblock/insert_block', array('class' => 'form-vertical','id' => 'validate'))?>
...
<!--                        <div class="form-group row">-->
<!--                            <label for="block_css" class="col-sm-3 col-form-label">--><?php //echo display('block_css')?><!--</label>-->
<!--                            <div class="col-sm-6">-->
<!--                                <textarea name="block_css" class="form-control" placeholder="--><?php //echo display('block_css')?><!--" id="block_css" row="3" ></textarea>-->
<!--                            </div>-->
<!--                        </div>-->
