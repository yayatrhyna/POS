        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cblock/block_update/{block_id}',array('class' => 'form-vertical', 'id' => 'validate'))?>
...
<!--                            <div class="col-sm-6">-->
<!--                                <textarea name="block_css" class="form-control" placeholder="--><?php //echo display('block_css')?><!--" id="block_css" row="3" >{block_css}</textarea>-->
<!--                            </div>-->
<!--                        </div>-->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <img src="<?php echo base_url();?>{block_image}" height="100" width="100" class="img img-responsive" style="margin-top:5px">
