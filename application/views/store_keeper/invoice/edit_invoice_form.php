        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open('Cinvoice/invoice_update', array('class' => 'form-vertical', 'id' => 'validate')) ?>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center"><?php echo display('discount') ?> <i
                                                class="text-danger">*</i></th>
                                    <th class="text-center"><?php echo display('total') ?> <i class="text-danger">*</i>
                                    </th>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="product_name" required
                                                       ...
                                                       value="<?php echo $value['product_name'] . '-(' . $value['product_model'] ?>)">
                                            ...
                                            <td class="text-center">
                                                <select name="variant_id[]" id="variant_id_<?php echo $i ?>"
                                                        class="form-control variant_id" required="" style="width: 100%">
                                                    <option value=""></option>
                                                    <?php
                                                    if ($exploded) {
                                                        foreach ($exploded as $elem) {
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $result->variant_id ?>" <?php if ($value['variant_id'] == $result->variant_id) {
                                                                echo "selected";
                                                            } ?>><?php echo $result->variant_name ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                            ...
                                            <td>
                                                <input type="text" id=""
                                                       ...
                                                       value="<?php echo $value['unit'] ?>" readonly=""/>
                                            </td>
                                            <td class="text-right">
                                                <input type="number" name="product_quantity[]"
                                                       ...
                                                       id="total_qntt_<?php echo $i ?>" class="form-control text-right"
                                                       min="1" required=""/>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="number" name="discount[]"
                                                       ...
                                                       placeholder="Discount" value="<?php echo $value['discount'] ?>"
                                                       min="0"/>
                                            </td>
                                            <td>
                                                ...
                                                <input type="hidden" name="invoice_details_id[]" id="invoice_details_id"
                                                       value="<?php echo $value['invoice_details_id'] ?>"/>
                                            </td>
                                            <td>
                                                ...
                                                <?php if ($tax['cgst_status'] == 1) { ?>
                                                    <input type="hidden" id="cgst_<?php echo $i ?>" class="cgst"
                                                           value="<?= (!empty($tax['cgst_tax']) ? $tax['cgst_tax'] : null) ?>"/>
                                                    <input type="hidden" id="total_cgst_<?php echo $i ?>"
                                                           class="total_cgst" name="cgst[]" value="<?= $cgst ?>"/>
                                                ...
                                                if ($tax['sgst_status'] == 1) { ?>
                                                    <input type="hidden" id="sgst_<?php echo $i ?>" class="sgst"
                                                           value="<?= (!empty($tax['sgst_tax']) ? $tax['sgst_tax'] : null) ?>"/>
                                                    <input type="hidden" id="total_sgst_<?php echo $i ?>"
                                                           class="total_sgst" name="sgst[]" value="<?= $sgst ?>"/>
                                                ...
                                                if ($tax['igst_status'] == 1) { ?>
                                                    <input type="hidden" id="igst_<?php echo $i ?>" class="igst"
                                                           value="<?= (!empty($tax['igst_tax']) ? $tax['igst_tax'] : null) ?>"/>
                                                    <input type="hidden" id="total_igst_<?php echo $i ?>"
                                                           class="total_igst" name="igst[]" value="<?= $igst ?>"/>
                                                    <input type="hidden" name="igst_id[]" id="igst_id_<?php echo $i ?>"
                                                           value="<?php echo $igst_id ?>">
                                                <?php } ?>
                                                <!-- Tax calculate end -->
                                ...
                                <?php if ($tax['cgst_status'] == 1) { ?>
                                    <tr>
                                        <td style="text-align:right;" colspan="7"><b><?php echo $tax['cgst_name'] ?>
                                                :</b></td>
                                        <td class="text-right">
                                            <input type="text" id="total_cgst" class="form-control text-right"
                                                   name="total_cgst" value="<?= $cgst_tax_amount ?>"
                                                   readonly="readonly"/>
                                        </td>
                                    </tr>
                                <?php }
                                if ($tax['sgst_status'] == 1) { ?>
                                    <tr>
                                        <td style="text-align:right;" colspan="7"><b><?php echo $tax['sgst_name'] ?>
                                                :</b></td>
                                        <td class="text-right">
                                            <input type="text" id="total_sgst" class="form-control text-right"
                                                   name="total_sgst" value="<?= $sgst_tax_amount ?>"
                                                   readonly="readonly"/>
                                        </td>
                                    </tr>
                                <?php }
                                if ($tax['igst_status'] == 1) { ?>
                                    <tr>
                                        <td style="text-align:right;" colspan="7"><b><?php echo $tax['igst_name'] ?>
                                                :</b></td>
                                        <td class="text-right">
                                            <input type="text" id="total_igst" class="form-control text-right"
                                                   name="total_igst" value="<?= $igst_tax_amount ?>"
                                                   readonly="readonly"/>
                                        </td>
                                    </tr>
                                <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" rowspan="4">
                                        ...
                                        <textarea class="form-control" name="invoice_details" id="invoice_details"
                                                  rows="6" placeholder="<?php echo display('invoice_details') ?>">{invoice_details}</textarea>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="total_discount_ammount" class="form-control text-right"
                                               name="total_discount" readonly="readonly" value="{total_discount}"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;" colspan="2">
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="invoice_discount" class="form-control text-right"
                                               name="invoice_discount" value="<?php if ($invoice_discount) {
                                            echo $invoice_discount - $total_discount;
                                        } ?>" onkeyup="calculateSum();" onchange="calculateSum();" placeholder="0.00"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;" colspan="2"><b><?php echo display('service_charge') ?>
                                            :</b></td>
                                    <td class="text-right">
                                        <input type="text" id="service_charge" class="form-control text-right"
                                               name="service_charge" value="<?php echo $service_charge ?>"
                                               placeholder="0.00" onkeyup="calculateSum();" onchange="calculateSum();"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:right;" colspan="2">
                                        ...
                                        <select name="shipping_method" id="shipping_method" class="form-control">
                                            ...
                                            foreach ($shipping_methods as $shipping_method):
                                                ?>
                                                <option <?php echo ($shipping_method['method_id'] == $shipping_method_id)? "selected" : ""?> data-amount="<?php echo $shipping_method['charge_amount']?>"  value="<?php echo $shipping_method['method_id']; ?>"><?php echo $shipping_method['method_name']; ?></option>
                                            <?php  endforeach; ?>
                                        </select>
                                    </td>
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="shipping_charge" class="form-control text-right"
                                               name="shipping_charge" value="<?php echo $shipping_charge; ?>" onkeyup="calculateSum();" placeholder="0.00"/>
                                    </td>
                                </tr>

                                <tr>
                                    <td colspan="2" style="text-align:right;"><b><?php echo display('grand_total') ?>
                                            :</b></td>
                                    <td class="text-right">
                                ...
                                <tr>
                                    <td align="center">
                                        <input type="button" class="btn -btn-info color4 color5" name="add-invoice-item"
                                    ...
                                    <td style="text-align:right;" colspan="6"><b><?php echo display('paid_ammount') ?>
                                            :</b></td>
                                    <td class="text-right">
