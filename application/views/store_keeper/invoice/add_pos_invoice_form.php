                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="mobile" id="mobile" type="number"
                                       placeholder="<?php echo display('customer_mobile') ?>" min="0">
                            </div>
                        </div>
            ...
            <div class="col-sm-7">
                <div class="panel panel-bd">
                                        ...
                                        if ($customer_list) {
                                            foreach ($customer_list as $customer_det) {
                                                if (1 == $customer_det->customer_id) {
                                                    ?>
                                                    <option selected
                                                            value="<?php echo $customer_det->customer_id ?>"><?php echo $customer_det->customer_name ?></option>
                                                <?php } else {
                                                    ?>
                                ...
                                if ($store_list) {
                                    foreach ($store_list as $store):
                                        if (1 == @$store->default_status) {
                                            ?>
                                            <option selected
                                                    value="<?php echo $store->store_id ?>"><?php echo $store->store_name ?></option>
                                        <?php } else { ?>
                            ...
                            <table class="table">
                                ...
                                <tr style="display:none">
                                    ...
                                    <?php if ($tax['cgst_status'] == 1) { ?>
                                        ...
                                        <td><input type="text" id="total_cgst" class="form-control text-right"
                                                   name="total_cgst" value="0.00" readonly="readonly"/></td>
                                    <?php } ?>
                                </tr>
                                <tr style="display:none">
                                    ...
                                    if ($tax['igst_status'] == 1) { ?>
                                        ...
                                        <td><input type="text" id="total_igst" class="form-control text-right"
                                                   name="total_igst" value="0.00" readonly="readonly"/></td>
                                    <?php } ?>
                                </tr>
                                <tr>
                    ...
                    <div class="panel-footer">
                        ...
                        <a href="<?php base_url('Cinvoice/manage_invoice') ?>" type="button"
	...
	function captureUrl(id) {
        ...
        var timeriframe = setInterval(function () {
            ...
            if (iframeDoc.readyState == 'complete' || iframeDoc.readyState == 'interactive') {
                ...
                html2canvas(iframe.contentDocument.getElementById("main"),{scale:10}).then(function($canvas) {
