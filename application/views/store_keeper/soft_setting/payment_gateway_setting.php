                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?php echo base_url('Csoft_setting/update_payment_gateway_setting/'.$setting['id'])?>" class="form-vertical" id="validate" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="sslcommerz_email" id="sslcommerz_email" type="email" value="<?php echo $setting['paypal_email']?>">
                                    </div>
                                    <div class="col-sm-2">
                                       <a href="https://signup.sslcommerz.com/register" target="_blank"><?php echo display('create_account')?></a>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" name="store_id" id="store_id" type="text" value="<?php echo $setting['shop_id']?>" placeholder="<?php echo display('store_id')?>">
