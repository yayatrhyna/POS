		            ...
		            <div class="panel-body">
		                <div class="table-responsive">
							...
							<?php foreach ($ledger as $v_ledger ){?>
									<tr>
										<td><?php echo $v_ledger['final_date'];?></td>
										<td>
                                           <?php if ($v_ledger['invoice_no'] !='NA'){ ?>
											<a href="<?php echo base_url().'Cinvoice/invoice_inserted_data/'.$v_ledger['invoice_no']; ?>">
												<?php echo  $v_ledger['invoice_no'];?>  <i class="fa fa-tasks pull-right" aria-hidden="true"></i>
											</a>
                                           <?php } ?>
										</td>
										<td>
											<?php echo $v_ledger['receipt_no']; ?>
										</td>
										<td><?php echo $v_ledger['description']?></td>
										...
										<td style="text-align:right;"> <?php echo (($position==0)?$currency.' '.$v_ledger['credit'] : $v_ledger['credit'].' '.$currency) ?></td>
										<td style="text-align:right;"> <?php echo (($position==0)? $currency.' '.$v_ledger['balance'] : $v_ledger['balance'].' '. $currency) ?></td>
									</tr>
