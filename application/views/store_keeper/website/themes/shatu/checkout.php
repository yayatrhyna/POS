...
<?php if ($this->cart->contents()) { ?>
    <form action="<?php echo base_url('submit_checkout') ?>" id="validateForm" method="post" class="checkout-conent">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-8">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <i class="fa fa-question-circle"></i> <?php echo display('returning_customer') ?><a
                                        ...
                                        href="#collapseOne"> <b><?php echo display('click_here_to_login') ?> </b></a>
                                </h4>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        if ($this->user_auth->is_logged() != 1) {
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <a href="#"
                                                   class="btn btn-warning customer_login color3"><?php echo display('login') ?></a>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <i class="fa fa-question-circle"></i><?php echo display('use_coupon_code') ?> <a
                                        ...
                                        href="#collapseThree"><b><?php echo display('enter_your_coupon_here') ?></b></a>
                            </h4>
                        </div>
                        <div id="collapseThree" class="panel-collapse collapse">
                            <div class="panel-body coupon">
                                <div class="form-inline">
                                    <input type="text" class="form-control col-sm-10" id="coupon_code"
                                           name="coupon_code"
                                           placeholder="<?php
                                           echo display('enter_your_coupon_here') ?>">
                                    <a href="#" class="btn color2 -text-white col-sm-2"
                    ...
                    <div class="billing-form">
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <select name="country" id="country" class="form-control" required>
                                        ...
                                        if ($selected_country_info) {
                                            foreach ($selected_country_info as $country) {
                                                ?>
                                                <option value="<?php echo $country->id ?>" <?php if ($this->session->userdata('country') == $country->id) {
                                                    echo "selected";
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="customer_email" name="customer_email"
                                           class="form-control" placeholder="<?php echo display('customer_email') ?>"
                                           required value="<?php echo $this->session->userdata('customer_email') ?>">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label for="customer_address_2"
                                           class="control-label"><?php echo display('customer_address_2') ?> : </label>
                                ...
                                <div class="form-group">
                                    <label for="city" class="control-label"><?php echo display('city') ?> <abbr
                                            class="required" title="required">*</abbr>:</label>
                                    <input type="text" name="city" id="city" placeholder="<?php echo display('city') ?>"
                        ...
                        <div class="checkbox checkbox-success">
                            <input type="checkbox" id="diff_ship_adrs" name="diff_ship_adrs"
                                   value="1" <?php if ($this->session->userdata('diff_ship_adrs') == 1) {
                                echo "checked";
                            } ?>>
                            <label for="diff_ship_adrs" data-toggle="collapse"
                                   data-target="#billind-different-address"><?php echo display('ship_to_a_different_address') ?></label>
                        </div>
                        ...
                        <div class="collapse <?php if ($this->session->userdata('diff_ship_adrs') == 1) {
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group has-error">
                                        ...
                                        <input type="text" name="ship_first_name" id="ship_first_name"
                                               placeholder="<?php echo display('first_name') ?>" class="form-control"
                                               required
                                    ...
                                    <div class="form-group">
                                        <label for="ship_country" class="control-label"><?php echo display('country') ?>
                                            <abbr class="required" title="required">*</abbr> : </label>
                                        <select name="ship_country" id="ship_country" class="form-control">
                                            ...
                                            if ($selected_country_info) {
                                                foreach ($selected_country_info as $country) {
                                                    ?>
                                                    <option value="<?php echo $country->id ?>" <?php if
                                                    ($this->session->userdata('ship_country') ==
                                                        $country->id) {
                                                        echo "selected";
                                                    } ?>><?php echo
                                                        $country->name ?> </option>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="ship_city" class="control-label"><?php echo display('city') ?> <abbr
                                                class="required" title="required">*</abbr> :</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="ship_zip" class="control-label"><?php echo display('zip') ?>
                                                    :</label>
                ...
                <div class="col-sm-4">
                    <div class="check-orde">
                        <h4><?php echo display('your_order');  ?></h4>
                        <table class="table">
                            <thead>
                            <tr>
                        ...
                        if ($select_shipping_method) {
                            foreach ($select_shipping_method as $shipping_method) {
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" required class="shipping_cost" name="shipping_cost"
                            ...
                            if ($sslcommerz_status == 1) {
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="payment_method"
                                               value="6">
                                        <img src="<?php echo base_url('my-assets/image/sslcommerz.png') ?>" alt="sslcommerz
                                        image">
                                    </label>
                                </div>
                            <?php } ?>
                        ...
                        <button type="submit"
                                class="btn btn-warning btn-block color3"
...
//    var loggedCustomer = "<?php //echo $this->session->userdata('customer_id')?>//";
//    if(loggedCustomer === '') {
...
//                    Swal({
//                        type: 'warning',
//                        title: '<?php //echo display('already_exists_please_login')?>//'
//                    });
//                    $('#email_warning').show();
//                    $('#email_warning').html("<?php //echo display('this_email_already_exists')  ?>//");
//                    $('#email_warning').css({'color': 'red'});
//                    $('#payment_method_sumbmit').prop('disabled', true);
//                    return false;
//                } else {
//                    $('#email_warning').hide();
//                    $('#payment_method_sumbmit').prop('disabled', false);
//                }
//            }
//        });
//    }
