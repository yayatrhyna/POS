                        ...
                        foreach ($brand_product as $product) {
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 pa-0">
                                <div class="product-box">
                                    <div class="imagebox">
                                        <span class="product-cat"><a href="<?php echo base_url('category/p/'.remove_space($product['product_name']).'/'.$product['category_id'])?>"><?php echo @$select_single_category->category_name?></a></span>
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                            ...
                            <a href="<?php echo base_url('product_details/'.remove_space($product['product_name']).'/'.$product['product_id'])?>">
                                <h3 class="product-name"><?php echo $product['product_name']?></h3>
                                <div class="product-thumb">
                                    <img src="<?php echo base_url()?>assets/website/img/loader.svg" data-src="<?php echo base_url().$product['image_thumb']?>" alt="">
                                </div>
                            </a>
                            <span>
                        <b>
