...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  <a href="<?php echo base_url('Cour_location/manage_our_location')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_our_location')?></a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cour_location/insert_our_location', array('class' => 'form-vertical','id' => 'validate'))?>
                                            ...
                                            <ul class="nav nav-pills nav-justified steps">
                                                ...
                                                <li>
                                                    <a href="#tab<?php echo $i?>" data-toggle="tab" class="step" aria-expanded="true">
                                                        ...
                                                        <span class="desc"><?php echo $language?></span>
                                                    </a>
                                                </li>
                                                <?php
                                                    $i++;
