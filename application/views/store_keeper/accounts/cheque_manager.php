		...
		<div class="row">
            <div class="col-sm-12">
                <div class="column">
                  	...
                  	<a href="<?php echo base_url('Caccounts')?>" class="btn -btn-info color4 color5 m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_received')?></a>  

                    <a href="<?php echo base_url('Caccounts/outflow')?>" class="btn btn-success color4 m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_payment')?></a>
