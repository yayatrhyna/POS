        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Caccounts/create_account')?>" class="btn btn-success color4 m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('create_accounts')?></a>
			           			...
			           			<thead>
									...
									?>
										<tr>
											...
											<td><?php echo $table['account_name']?></td>
											<td>
											<?php 
											...
											<td>
												<center>
													<?php echo form_open()?>
													<a href="<?php echo base_url('Caccounts/account_edit/'.$table['account_id']); ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
													<?php echo form_close()?>	
												</center>
											</td>
										</tr>
