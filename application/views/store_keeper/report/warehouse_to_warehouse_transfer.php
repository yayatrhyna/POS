...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1><?php echo display('warehouse_to_warehouse_transfer') ?></h1>
	        <small><?php echo display('warehouse_to_warehouse_transfer') ?></small>
	        <ol class="breadcrumb">
	            <li><a href="index.html"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('report') ?></a></li>
	            <li class="active"><?php echo display('warehouse_to_warehouse_transfer') ?></li>
	        </ol>
	    </div>
	</section>
		                ...
		                <div class="table-responsive">
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
		                        ...
		                        if ($warehouse_to_warehouse_transfer) {
		                        	foreach ($warehouse_to_warehouse_transfer as $report) {
		                        ?>
		                        	<tr>
										<td><?php echo $report['date_time']?></td>
										<td><?php echo $report['wearhouse_name']?></td>
