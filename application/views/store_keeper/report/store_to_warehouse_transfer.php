...
<div class="content-wrapper">
	<section class="content-header">
	    ...
	    <div class="header-title">
	        <h1><?php echo display('store_to_warehouse_transfer') ?></h1>
	        <small><?php echo display('store_to_warehouse_transfer') ?></small>
	        <ol class="breadcrumb">
	            <li><a href="index.html"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
	            <li><a href="#"><?php echo display('report') ?></a></li>
	            <li class="active"><?php echo display('store_to_warehouse_transfer') ?></li>
	        </ol>
	    </div>
	</section>
			...
			<div class="col-sm-12">
		        <div class="panel panel-default">
		            <div class="panel-body"> 
		                <?php echo form_open('Admin_dashboard/store_to_warehouse_transfer',array('class' => ''))?>
	                        ...
	                        <div class="form-group row">
	                            <label for="t_wearhouse" class="col-sm-2 col-form-label"><?php echo display('t_wearhouse') ?>:</label>
	                            <div class="col-sm-4">
	                                <select class="form-control" name="t_wearhouse" id="t_wearhouse"  required="">
	                                <option value=""></option>
			                        {wearhouse_list}
		                ...
		                <div class="table-responsive">
		                    <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
		                        ...
		                        if ($store_to_warehouse_transfer) {
		                        	foreach ($store_to_warehouse_transfer as $report) {
		                        ?>
		                        	<tr>
										<td><?php echo $report['date_time']?></td>
										<td><?php echo $report['store_name']?></td>
										<td><?php echo $report['t_wearhouse_name']?></td>
