                        ...
                        <div class="row">
                            <div class="form-group col-lg-8 col-sm-offset-2">
                                <blink class="text-success text-center"
                                       style="font-size: 32px;margin-bottom: 36px;display: block;"><?php echo @$message_txt ?></blink>
                                <blink class="text-waring text-center"
                                       style="font-size: 32px;margin-bottom: 36px;display: block;"><?php echo @$exception_txt ?></blink>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="alert alert-success text-center"
                                             style="font-size:18px;    line-height: 28px;">Latest version
                                            <br>V-<?php echo $latest_version ?></div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="alert alert-danger text-center"
                                             style="font-size:18px;    line-height: 28px;">Current version
                                            <br>V-<?php echo $current_version ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style type="text/css">
    ...
    / / for android animation: 2 s linear infinite condemned_blink_effect;
    }
