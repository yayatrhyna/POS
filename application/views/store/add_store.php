        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column">
                  ...
                  <a href="<?php echo base_url('Cstore/manage_store')?>" class="btn -btn-info color4 color5 m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('manage_store')?></a>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                  ...
                  <?php echo form_open_multipart('Cstore/insert_store', array('class' => 'form-vertical','id' => 'validate'))?>
