        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cinvoice/insert_invoice', array('class' => 'form-vertical', 'id' => 'validate', 'name' => 'insert_invoice')) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8" id="payment_from_1">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" size="100" value="<?php echo $customer['customer_name']; ?>"
                                               name="customer_name" class="customerSelection form-control"
                                               placeholder='<?php echo display('customer_name') ?>' id="customer_name"
                                               required/>
                                        <input id="SchoolHiddenId" value="<?php echo $customer['customer_id'] ?>"
                                        ...
                                        <select class="form-control" id="store_id" required="" name="store_id">
                                            ...
                                            <?php foreach ($store_list as $v_store_list):
                                                if (1 == $v_store_list['default_status']) {
                                                    ?>
                                                    <option selected
                                                            value="<?php echo $v_store_list['store_id'] ?>"><?php echo $v_store_list['store_name'] ?></option>
                                                <?php } else {
                                                    ?>
                                                    <option value="<?php echo $v_store_list['store_id'] ?>"><?php echo $v_store_list['store_name'] ?></option>
                                                    <?php
                                                }
                                            endforeach; ?>
                                        </select>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <select name="variant_id[]" id="variant_id_1" class="form-control variant_id"
                                    ...
                                    <td style="text-align:right;" colspan="2">
                                        ...
                                        <select name="shipping_method" id="shipping_method" class="form-control">
                                            ...
                                            <?php foreach ($shipping_methods as $shipping_method): ?>
                                                    <option value="<?php echo $shipping_method['method_id']; ?>" data-amount="<?php echo $shipping_method['charge_amount']; ?>"><?php echo $shipping_method['method_name']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="7" style="text-align:right;"><b><?php echo display('grand_total') ?>
                                            :</b></td>
                                    <td class="text-right">
                                ...
                                <tr>
                                    <td align="center" style="width: 220px">
                                        ...
                                        <input type="submit" id="add-invoice" class="btn btn-success" name="add-invoice"
            ...
            <script type="text/javascript">
                ...
                function addInputField(divName) {
                    ...
                    if (count == limits) {
                        ...
                        newdiv.innerHTML = '<tr><td><input type="text" name="product_name" onkeyup="invoice_productList(' + count + ');" class="form-control productSelection" placeholder="<?php echo display('product_name') ?>" required="" id="product_name_' + count + '" ><input type="hidden" class="autocomplete_hidden_value product_id_' + count + '" name="product_id[]"/><input type="hidden" class="sl" value="' + count + '"><input type="hidden" class="baseUrl" value="<?php echo base_url();?>" /></td>' +
                ...
                $('body').on('change', '.variant_id', function () {
                    ...
                    $.ajax({
                        type: "post",
                        async: false,
                        url: '<?php echo base_url('Cpurchase/check_product_stock')?>',
