...
class Lsetting {
	...
	public function about_us($page_id)
	{
		...
		$HomeForm = $CI->parser->parse('website/themes/'.$theme.'/about_us',$data,true);
		return $HomeForm;
	}	
	...
	public function delivery_info($page_id)
	{
		...
		$HomeForm = $CI->parser->parse('website/themes/'.$theme.'/delivery_info',$data,true);
		return $HomeForm;
	}	
	...
	public function privacy_policy($page_id)
	{
		...
		$HomeForm = $CI->parser->parse('website/themes/'.$theme.'/privacy_policy',$data,true);
		return $HomeForm;
	}	
	...
	public function terms_condition($page_id)
	{
		...
		$HomeForm = $CI->parser->parse('website/themes/'.$theme.'/terms_condition',$data,true);
		return $HomeForm;
	}	
	...
	public function help($page_id)
	{
		...
		$HomeForm = $CI->parser->parse('website/themes/'.$theme.'/help',$data,true);
		return $HomeForm;
	}	
	...
	public function contact_us()
	{
		...
		$HomeForm = $CI->parser->parse('website/themes/'.$theme.'/contact_us',$data,true);
		return $HomeForm;
	}
}
?>