...
class Lpay_with {
	...
	public function pay_with_list(){
		...
		$CI =& get_instance();
		$CI->load->model('store_keeper/pay_withs');
		$pay_with_lists = $CI->pay_withs->pay_with_list(); 
		$data=[
			'pay_with_lists'=>$pay_with_lists
		];
		$pay_with_lists = $CI->parser->parse('pay_with/index',$data,true);
	...
	public function pay_with_add_form()
	{
		...
		$pay_with = $CI->parser->parse('pay_with/create',$data,true);
		return $pay_with;
	}
	...
	public function pay_with_edit_form($id)
	{
		...
		$pay_with_data = $CI->parser->parse('pay_with/edit',$data,true);
