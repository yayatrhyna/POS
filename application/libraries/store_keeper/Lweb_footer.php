...
class Lweb_footer {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/Web_footers');
		...
		$customerForm = $CI->parser->parse('web_footer/add_web_footer',$data,true);
		return $customerForm;
	}
	...
	public function web_footer_list()
	{
		...
		$customerList = $CI->parser->parse('web_footer/web_footer',$data,true);
		return $customerList;
	}
	...
	public function web_footer_edit_data($footer_section_id)
	{
		...
		$chapterList = $CI->parser->parse('web_footer/edit_web_footer',$data,true);
		return $chapterList;
	}
}
?>