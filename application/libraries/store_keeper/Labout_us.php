...
class Labout_us {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/About_us');
		...
		$customerForm = $CI->parser->parse('about_us/add_about_us',$data,true);
		return $customerForm;
	}
	...
	public function about_us_list()
	{
		...
		$customerList = $CI->parser->parse('about_us/about_us',$data,true);
		return $customerList;
	}
	...
	public function about_us_edit_data($content_id)
	{
		...
		$chapterList = $CI->parser->parse('about_us/edit_about_us',$data,true);
		return $chapterList;
	}
}
?>