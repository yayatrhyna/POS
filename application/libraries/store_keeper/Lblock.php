...
class Lblock {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/Blocks');
		...
		$customerForm = $CI->parser->parse('block/add_block',$data,true);
		return $customerForm;
	}
	...
	public function block_list()
	{
		...
		$customerList = $CI->parser->parse('block/block',$data,true);
		return $customerList;
	}
	...
	public function block_edit_data($block_id)
	{
		...
		$chapterList = $CI->parser->parse('block/edit_block',$data,true);
		return $chapterList;
	}
}
?>