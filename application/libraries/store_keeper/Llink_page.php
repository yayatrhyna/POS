...
class Llink_page {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/Link_pages');
		$CI->load->model('store_keeper/Link_pages');
		...
		$customerForm = $CI->parser->parse('link_page/add_link_page',$data,true);
		return $customerForm;
	}
	...
	public function link_page_list()
	{
		...
		$customerList = $CI->parser->parse('link_page/link_page',$data,true);
		return $customerList;
	}
	...
	public function link_page_edit_data($page_id)
	{
		...
		$chapterList = $CI->parser->parse('link_page/edit_link_page',$data,true);
		return $chapterList;
	}
}
?>