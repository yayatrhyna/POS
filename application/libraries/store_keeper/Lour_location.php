...
class Lour_location {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/Our_location');
		$CI->load->model('store_keeper/website/Homes');
		...
		$customerForm = $CI->parser->parse('our_location/add_our_location',$data,true);
		return $customerForm;
	}
	...
	public function our_location_list()
	{
		...
		$customerList = $CI->parser->parse('our_location/our_location',$data,true);
		return $customerList;
	}
	...
	public function our_location_edit_data($position)
	{
		...
		$chapterList = $CI->parser->parse('our_location/edit_our_location',$data,true);
		return $chapterList;
	}
}
?>