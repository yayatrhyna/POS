...
class Ltax {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/Taxs');
		...
		$customerList = $CI->parser->parse('tax/tax',$data,true);
		return $customerList;
	}
	...
	public function tax_edit_data($t_p_s_id)
	{
		...
		$chapterList = $CI->parser->parse('tax/edit_tax',$data,true);
		return $chapterList;
	}	
	...
	public function tax_product_update_form($t_p_s_id)
	{
		...
		$chapterList = $CI->parser->parse('tax/edit_product_tax',$data,true);
		return $chapterList;
	}
	//Tax product service
	public function tax_product_service(){
		...
		$chapterList = $CI->parser->parse('tax/tax_product_service',$data,true);
		return $chapterList;
	}	
	...
	public function tax_setting(){
		...
		$chapterList = $CI->parser->parse('tax/tax_setting',$data,true);
		return $chapterList;
	}
}
?>