...
class Lsubscriber {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/Subscribers');
		$data = array(
				'title' => display('add_subscriber')
			);
		$customerForm = $CI->parser->parse('subscriber/add_subscriber',$data,true);
		return $customerForm;
	}
	...
	public function subscriber_list()
	{
		...
		$customerList = $CI->parser->parse('subscriber/subscriber',$data,true);
		return $customerList;
	}
	...
	public function subscriber_edit_data($subscriber_id)
	{
		...
		$chapterList = $CI->parser->parse('subscriber/edit_subscriber',$data,true);
		return $chapterList;
	}
}
?>