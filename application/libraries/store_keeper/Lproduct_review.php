...
class Lproduct_review {
	...
	{
		$CI =& get_instance();
		$CI->load->model('store_keeper/Product_reviews');
		...
		$customerForm = $CI->parser->parse('product_review/add_product_review',$data,true);
		return $customerForm;
	}
	...
	public function product_review_list()
	{
		...
		$customerList = $CI->parser->parse('product_review/product_review',$data,true);
		return $customerList;
	}
	...
	public function product_review_edit_data($product_review_id)
	{
		...
		$chapterList = $CI->parser->parse('product_review/edit_product_review',$data,true);
		return $chapterList;
	}
}
?>