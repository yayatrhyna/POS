...
class Customer_dashboard extends CI_Controller
{
    ...
    public function wishlist()
    {
        ...
        // $wishlists=$this->db->select('*')->where('user_id',$customer_id)->from('wishlist')->get()->row();
        ...
        $content = $this->parser->parse('website/customer/wishlist', $data, true);
        $this->template->full_customer_html_view($content);
    }
    ...
    public function wishlist_delete($wishlist_id)
    {
        ...
        redirect('customer/customer_dashboard/wishlist');
    }
