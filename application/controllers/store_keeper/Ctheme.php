...
class Ctheme extends CI_Controller
{

    function __construct()
    {
        parent::__construct();
        $this->load->model('store_keeper/Themes');
    ...
    public function upload_new_theme()
    {
        ...
        $target_dir = 'application/views/website/themes';
        ...
        $config = array();
        $config['upload_path'] = './application/views/website/themes/';
