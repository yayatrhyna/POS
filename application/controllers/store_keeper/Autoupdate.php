...
//Get Update file
define('MIN_VERSION', file_get_contents('https://update.bdtask.com/isshue/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('https://update.bdtask.com/isshue/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','https://update.bdtask.com/isshue/autoupdate');
// Get latest version info
define('UPDATE_INFO_URL','https://update.bdtask.com/isshue/autoupdate/update_info');
// CRM temporary path
...
class Autoupdate extends CI_Controller
{
    ...
    function __construct() {
        parent::__construct();
        $this->load->library('store_keeper/user_agent');
    }
...
//        $this->load->view("backend/layout/main_wrapper", $data);
        $content=$CI->parser->parse('backend/autoupdate/autoupdate',$data,true);
